  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "同意の既定は地域によって異なります。EEA・英国・スイスからのアクセスでは、これらの分析・広告 Cookie は既定で無効とし、バナーで許可された場合のみ有効化します。それ以外の地域（米国等）では既定で有効とし、バナーからいつでも拒否（オプトアウト）できます。",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Default consent depends on your region. For visitors in the EEA, the UK, and Switzerland, analytics and advertising cookies are off by default and enabled only if you accept via the banner. Elsewhere (including the US), they are on by default and you can decline (opt out) anytime via the banner.",

...
export const copy = {
  ja: {
    ...
    observationVerificationReport: {
      ...
      openReport: "検証レポート",
      title: "検証レポート",
      subtitle: "記録時点の識別子とハッシュ値（1 ページ・印刷 / PDF 保存用）",
      print: "印刷 / PDF 保存",
      printHint: "ブラウザの印刷ダイアログで「PDF に保存」を選べます。追加コストはかかりません。",
      disclaimer:
        "参照用の検証サマリーです。法的証明や第三者監査の代替にはなりません。SHA256・pHash が未記録の行は「—」と表示されます。",
  ...
  en: {
    ...
    observationVerificationReport: {
      back: "Back to detail",
      openReport: "Verification report",
      title: "Verification report",
      subtitle: "Record identifiers and hashes at capture time (one page, print / Save as PDF)",
      print: "Print / Save as PDF",
      printHint: "Choose “Save as PDF” in your browser print dialog. No extra cost.",
      disclaimer:
        "Reference verification summary only—not a substitute for legal proof or third-party audit. Missing SHA256/pHash shows as “—”.",
      fieldObservationId: "Observation ID",
      fieldUrl: "URL",
      fieldCaptureTime: "Capture Time",
      fieldCountry: "Country",

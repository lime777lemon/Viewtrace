...
export const copy = {
  ja: {
    ...
    observationsListPage: {
      ...
      searchLabel: "検索",
      searchPlaceholder: "URL、ページ名、地域、タグ",
      allTags: "すべて",
      untagged: "タグなし",
      resultCount: "{shown} / {total} 件",
      noSearchMatch: "条件に合うオブザベーションがありません。",
      addTagPlaceholder: "タグを追加",
      addTag: "追加",
      addingTag: "…",
      addTagFailed: "追加できませんでした",
      tagUrlHint: "タグを付けると、同じ URL の記録すべてに保存されます。",
    },
    ...
    observationAnnotation: {
      title: "注釈（Annotation）",
      hint: "タグは同じ URL の記録すべてに保存されます。メモとフォルダはこの記録だけです。証跡（画像・ハッシュ）には影響しません。",
      noteLabel: "メモ",
  ...
  en: {
    ...
    observationsListPage: {
      ...
      searchLabel: "Search",
      searchPlaceholder: "URL, page title, region, or tag",
      allTags: "All",
      untagged: "Untagged",
      resultCount: "{shown} of {total}",
      noSearchMatch: "No observations match these filters.",
      addTagPlaceholder: "Add a tag",
      addTag: "Add",
      addingTag: "…",
      addTagFailed: "Could not add",
      tagUrlHint: "Adding a tag saves it on every record of that URL.",
    },
    observationsCsvExport: {
    ...
    observationAnnotation: {
      title: "Annotation",
      hint: "Tags are saved on every record of the same URL. Notes and folder stay on this record. They do not change the evidence.",
      noteLabel: "Note",

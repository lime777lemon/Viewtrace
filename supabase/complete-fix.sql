-- ============================================
-- Complete Fix: Search Path + Email Confirmation
...
-- Part 3: Enable email confirmation for specific user (redundant but safe)
UPDATE auth.users 
SET email_confirmed_at = NOW() 
WHERE email = 'yuki.ikeda7887@gmail.com';

-- Part 4: Verify the update for specific user
SELECT 
  email,
  email_confirmed_at,
  CASE 
...
-- Part 5: Summary - Check all users
SELECT 

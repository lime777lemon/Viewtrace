-- ============================================
-- Fix Duplicate Users Issue (Production Version)
-- Run this in Supabase SQL Editor
-- Sets subscription_status to 'inactive' (requires Stripe payment)
-- ============================================
...
-- Note: subscription_status is set to 'inactive' (requires Stripe payment)
...
SELECT 
  ...
  'inactive' as subscription_status, -- Requires Stripe payment
  CASE 
